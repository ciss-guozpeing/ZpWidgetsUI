...
ZpNotification::ZpNotification(int displayTime, QWidget *parent) : QWidget(parent),
...
void ZpNotification::showGriant()
{
    this->show();
...
void ZpNotification::hideGriant()
{
    QPropertyAnimation *animation = new QPropertyAnimation(this, "windowOpacity", this);
...
void ZpNotification::mousePressEvent(QMouseEvent *event)
{
...
void ZpNotification::setUrl(const QString &value)
{
    url = value;
}


void ZpNotification::setBody(const QString &value)
{
    body = value;
}

void ZpNotification::setTitle(const QString &value)
{
    title = value;
}

void ZpNotification::setIcon(const QString &value)
{
    icon = value;
}
